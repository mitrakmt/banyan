    ...
    <div className="salaryCalculator">
      ...
      <div className="salaryCalculator-container">
        <div className="salaryCalculator-container-child">
          ...
          <h5>Immediate potential salary increase: <span className="salaryCalculator-boldText">${(engineerSalary.midSalary - roles[selectedRole].midSalary).toLocaleString()}</span> / yr</h5>
          <h5>3 year potential salary increase: <span className="salaryCalculator-boldText">${(engineerSalary.seniorSalary - roles[selectedRole].seniorSalary).toLocaleString()}</span> / yr</h5>
        </div>
